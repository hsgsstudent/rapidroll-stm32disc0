...
BlitOperations STM32DMA::getBlitCaps() {
  return static_cast<BlitOperations>(BLIT_OP_FILL | BLIT_OP_FILL_WITH_ALPHA | BLIT_OP_COPY | BLIT_OP_COPY_L8 |
                                     BLIT_OP_COPY_WITH_ALPHA | BLIT_OP_COPY_ARGB8888 |
...
void STM32DMA::setupDataCopy(const BlitOp &blitOp) {
  ...
  case BLIT_OP_COPY_WITH_ALPHA:
    /* Set DMA2D color mode and alpha mode */
    WRITE_REG(DMA2D->FGPFCCR,
              dma2dForegroundColorMode | (DMA2D_COMBINE_ALPHA << DMA2D_FGPFCCR_AM_Pos) | (blitOp.alpha << 24));
  ...
  case BLIT_OP_COPY_L8: {
    ...
    case Bitmap::CLUT_FORMAT_L8_ARGB8888:
      ...
      MODIFY_REG(DMA2D->FGPFCCR, (DMA2D_FGPFCCR_CS | DMA2D_FGPFCCR_CCM),
                 (((palette->size - 1) << DMA2D_FGPFCCR_CS_Pos) | (DMA2D_CCM_ARGB8888 << DMA2D_FGPFCCR_CCM_Pos)));
      break;
    case Bitmap::CLUT_FORMAT_L8_RGB888:
      ...
      MODIFY_REG(DMA2D->FGPFCCR, (DMA2D_FGPFCCR_CS | DMA2D_FGPFCCR_CCM),
                 (((palette->size - 1) << DMA2D_FGPFCCR_CS_Pos) | (DMA2D_CCM_RGB888 << DMA2D_FGPFCCR_CCM_Pos)));
      break;
...
void STM32DMA::setupDataFill(const BlitOp &blitOp) {
  ...
  if (blitOp.operation == BLIT_OP_FILL_WITH_ALPHA) {
    ...
    WRITE_REG(DMA2D->FGPFCCR, DMA2D_INPUT_A8 | (DMA2D_REPLACE_ALPHA << DMA2D_FGPFCCR_AM_Pos) |
                                  ((blitOp.alpha << 24) & DMA2D_FGPFCCR_ALPHA));
    ...
    /* Set color */
    WRITE_REG(DMA2D->OCOLR,
              ((blitOp.color >> 8) & 0xF800) | ((blitOp.color >> 5) & 0x07E0) | ((blitOp.color >> 3) & 0x001F));
...
void lineFromColor(uint16_t *const ptr, const unsigned count, const uint32_t color, const uint8_t alpha,
  ...
  if (alpha < 0xFF) {
    ...
    /* Write DMA2D FGPFCCR register */
    WRITE_REG(DMA2D->FGPFCCR,
              DMA2D_INPUT_A8 | (DMA2D_REPLACE_ALPHA << DMA2D_FGPFCCR_AM_Pos) | (alpha << DMA2D_FGPFCCR_ALPHA_Pos));
...
void lineFromRGB565(uint16_t *const ptr, const uint16_t *const data, const unsigned count, const uint8_t alpha) {
  ...
  if (alpha < 0xFF) {
    /* Set DMA2D color mode and alpha mode */
    WRITE_REG(DMA2D->FGPFCCR,
              DMA2D_INPUT_RGB565 | (DMA2D_COMBINE_ALPHA << DMA2D_FGPFCCR_AM_Pos) | (alpha << DMA2D_FGPFCCR_ALPHA_Pos));
...
void lineFromARGB8888(uint16_t *const ptr, const uint32_t *const data, const unsigned count, const uint8_t alpha) {
  ...
  /* Set DMA2D color mode and alpha mode */
  WRITE_REG(DMA2D->FGPFCCR,
            DMA2D_INPUT_ARGB8888 | (DMA2D_COMBINE_ALPHA << DMA2D_BGPFCCR_AM_Pos) | (alpha << DMA2D_FGPFCCR_ALPHA_Pos));
...
void lineFromL8RGB888(uint16_t *const ptr, const uint8_t *const data, const unsigned count, const uint8_t alpha) {
  ...
  if (L8ClutLoaded == 0) {
    ...
    /* Set DMA2D color mode and alpha mode */
    WRITE_REG(DMA2D->FGPFCCR,
              DMA2D_INPUT_L8 | (DMA2D_COMBINE_ALPHA << DMA2D_BGPFCCR_AM_Pos) | (alpha << DMA2D_FGPFCCR_ALPHA_Pos));

    MODIFY_REG(DMA2D->FGPFCCR, (DMA2D_FGPFCCR_CS | DMA2D_FGPFCCR_CCM),
               (((L8CLUT->size - 1) << DMA2D_FGPFCCR_CS_Pos) | (DMA2D_CCM_RGB888 << DMA2D_FGPFCCR_CCM_Pos)));
...
void lineFromL8ARGB8888(uint16_t *const ptr, const uint8_t *const data, const unsigned count, const uint8_t alpha) {
  ...
  if (L8ClutLoaded == 0) {
    ...
    MODIFY_REG(DMA2D->FGPFCCR, (DMA2D_FGPFCCR_CS | DMA2D_FGPFCCR_CCM),
               (((L8CLUT->size - 1) << DMA2D_FGPFCCR_CS_Pos) | (DMA2D_CCM_ARGB8888 << DMA2D_FGPFCCR_CCM_Pos)));
